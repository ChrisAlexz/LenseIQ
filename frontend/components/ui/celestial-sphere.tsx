  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        vec3 color = hsl2rgb(vec3(u_hue / 360.0 + nebula * 0.05, 0.7, 0.5));
        color *= nebula * 2.5;
    ...
    const animate = () => {
      if (speed > 0) {
        ...
        // Static: render a single frame at a fixed time for a nice nebula snapshot
        material.uniforms.u_time.value = 8.0;
        renderer.render(scene, camera);
      }
    };
